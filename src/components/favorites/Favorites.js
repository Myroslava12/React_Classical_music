...
const Favorites = () => {
    ...
    return (
        <div className="favorites--dashboard">
            {!favoritesArrayIsNotEmpty && <h1 className="favorite--title">Your list of works by favorite composers is still empty</h1>}
            {favoritesArrayIsNotEmpty && <h1 className="favorite--title">Your list of works by favorite composers</h1>}
